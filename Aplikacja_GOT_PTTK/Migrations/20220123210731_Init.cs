        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GOTPoints = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PathModel", x => x.PathId);
                    table.ForeignKey(
                        name: "FK_PathModel_AccountModel_AccountId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PathModelPathId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_GeoPointModel", x => x.GeoPointId);
                    table.ForeignKey(
                        name: "FK_GeoPointModel_PathModel_PathModelPathId",
                        column: x => x.PathModelPathId,
